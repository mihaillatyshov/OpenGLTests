...
Chunk::Chunk()
{
	...
	m_Materials["Grass_Top"] = std::make_shared<Material>(m_Textures["Dirth_Top"], glm::vec4(1.0f));
	m_Materials["Grass_Side"] = std::make_shared<Material>(m_Textures["Dirth_Side"], glm::vec4(1.0f));
	m_Materials["Grass_Bot"] = std::make_shared<Material>(m_Textures["Dirth_Bot"], glm::vec4(1.0f));

	m_Materials["Dirth_Top"] = std::make_shared<Material>(m_Textures["Dirth_Bot"], glm::vec4(1.0f));
	m_Materials["Dirth_Side"] = m_Materials["Dirth_Top"];
	m_Materials["Dirth_Bot"] = m_Materials["Dirth_Top"];

	m_Materials["Stone_Top"] = std::make_shared<Material>(m_Textures["Stone"], glm::vec4(1.0f));
	...
	Unit::s_Materials["Grass"] = std::make_shared<Material>(Unit::s_Textures["Dirth"], glm::vec4(1.0f));
