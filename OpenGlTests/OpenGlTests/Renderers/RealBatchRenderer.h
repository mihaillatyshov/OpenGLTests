...
protected:
	...
	std::vector<std::shared_ptr<Material>> m_Materials; // std::vector<uint32_t> m_Materials; /* Use with Material manager!!! */
...
public:
	...
	virtual void PushTransform(std::shared_ptr<LM::Transformation> transformation) { };
