...
namespace LM
{
	...
	public:
		...
		virtual void PushTransform(std::shared_ptr<LM::Transformation> transformation) override;
		...
		inline TransformTree* GetTransformTree() { return &m_TransformationTree; }
	...
	protected:
		...
		std::vector<glm::mat4> m_Transformations;
		std::shared_ptr<TextureBuffer> m_TransformTexture;
		TransformTree m_TransformationTree;
	};
