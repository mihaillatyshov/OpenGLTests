...
void RealBatchRendererLayer::OnAttach()
{
	...
	for (int i = 0; i < TexturesCount; i++)
	{
		...
		m_Materials.push_back(std::make_shared<Material>(m_Textures[i], glm::vec4(1.0f, 1.0f, 1.0f, 1.0f)));
	...
	m_BlendMaterials.push_back(std::make_shared<Material>(nullptr, glm::vec4(1.0f, 0.0f, 0.0f, 0.5f)));
